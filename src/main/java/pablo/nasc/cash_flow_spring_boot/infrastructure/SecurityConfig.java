    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v2/autenticacao/**").permitAll()
                        .requestMatchers("/h2-console/**").permitAll()
                        .requestMatchers("/swagger-ui/**", "/swagger-ui.html").permitAll()
                        .requestMatchers("/v1/api-docs", "/v1/api-docs/**").permitAll()
                        .requestMatchers("/v2/api-docs", "/v2/api-docs/**").permitAll()
                        .requestMatchers("/internal/api-docs/swagger-config").permitAll()
